...
public final class Constants {
    ...
    private static final String PACKAGE_NAME = "com.groupproject.cs3.vca";
    ...
    static {
       ...
       // BAY_AREA_LANDMARKS.put("Fota Rock, Cork", new LatLng(lats, lons));
        //BAY_AREA_LANDMARKS.put(" Carrigtwohill, Cork ", new LatLng(51.912814, -8.250851));
      //  BAY_AREA_LANDMARKS.put(" Cork Institute of Technology ", new LatLng(51.884893, -8.533770));
        // Googleplex.
