...
public class takeAwayActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sidebar_takeaway);
        ...
        getSupportActionBar().setTitle("VCA");
        mAuth = FirebaseAuth.getInstance();
        userID = mAuth.getUid();


        final EditText getTA = findViewById(R.id.getTA);
        final EditText gettaNo = findViewById(R.id.taPhoneNo);
        Button saveTA = findViewById(R.id.saveTakeAway);

        list = findViewById(R.id.listview);
        final ArrayAdapter<String> adapter = new ArrayAdapter<>(this, R.layout.mytextview, foodList);
        ...
        saveTA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                String nameNo = getTA.getText().toString();
                String phoneNo = gettaNo.getText().toString();
                myFood.child("users").child(userID).child("Food").child(nameNo).setValue(phoneNo);
                Toast.makeText(takeAwayActivity.this.getApplicationContext(), "Take Away Saved", Toast.LENGTH_SHORT).show();
                foodList.clear();
                noList.clear();
                DatabaseReference myRef = database.getReferenceFromUrl("https://vcafirebaseproject-40148.firebaseio.com/users/" + userID + "/Food");
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (key != null) {
                                ...
                                noList.add(value);
                                foodList.add(key + ": " + value);
                                adapter.notifyDataSetChanged();
                                Toast.makeText(takeAwayActivity.this.getApplicationContext(), "List updated", Toast.LENGTH_SHORT).show();
                            }
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (ActivityCompat.checkSelfPermission(takeAwayActivity.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
